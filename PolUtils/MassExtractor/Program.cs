		...
		private static int Main()
		{
			...
			try
			{
				...
				for (int count = 0; count < Args.Length; count++)
				{
					...
					else if (Args[count].ToLower() == "-music")
					{
						ExtractMusic = true;
					}
					else
				...
				else
				{
					...
					Program.ExtractFile(55701, "abilE.xml");
					Program.ExtractFile(55465, "areaE.xml");
					Program.ExtractFile(55702, "spellE.xml");
					Program.ExtractFile(55726, "statusE.xml");
					...
					Program.ExtractFile(56237, "weaponF.xml");
					Program.ExtractFile(56238, "armorF.xml");
					Program.ExtractFile(56208, "armor2F.xml");
					Program.ExtractFile(56239, "puppetF.xml");
					Program.ExtractFile(56240, "currencyF.xml");
					Program.ExtractFile(56207, "slipF.xml");
					Program.ExtractFile(56241, "abilF.xml");
					Program.ExtractFile(56195, "areaF.xml");
					Program.ExtractFile(56242, "spellF.xml");
					Program.ExtractFile(56272, "statusF.xml");

					Program.ExtractFile(55815, "generalD.xml");
					Program.ExtractFile(55791, "general2D.xml");
					Program.ExtractFile(55816, "usableD.xml");
					Program.ExtractFile(55817, "weaponD.xml");
					Program.ExtractFile(55818, "armorD.xml");
					Program.ExtractFile(55788, "armor2D.xml");
					Program.ExtractFile(55819, "puppetD.xml");
					Program.ExtractFile(55820, "currencyD.xml");
					Program.ExtractFile(55787, "slipD.xml");
					Program.ExtractFile(55821, "abilD.xml");
					Program.ExtractFile(55775, "areaD.xml");
					Program.ExtractFile(55822, "spellD.xml");
					Program.ExtractFile(55852, "statusD.xml");

					Program.ExtractFile(4, "generalJ.xml");
					Program.ExtractFile(55551, "general2J.xml");
					Program.ExtractFile(5, "usableJ.xml");
					Program.ExtractFile(6, "weaponJ.xml");
					Program.ExtractFile(7, "armorJ.xml");
					Program.ExtractFile(55548, "armor2J.xml");
					Program.ExtractFile(8, "puppetJ.xml");
					Program.ExtractFile(9, "currencyJ.xml");
					Program.ExtractFile(55547, "slipJ.xml");
					Program.ExtractFile(55581, "abilJ.xml");
					Program.ExtractFile(55535, "areaJ.xml");
					Program.ExtractFile(55582, "spellJ.xml");
					Program.ExtractFile(55605, "statusJ.xml");
