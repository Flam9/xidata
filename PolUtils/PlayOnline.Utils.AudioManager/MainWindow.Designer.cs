...
namespace PlayOnline.Utils.AudioManager {
  ...
  public partial class MainWindow {
    ...
    private void InitializeComponent() {
			...
			this.DecodeAllMusic = new System.Windows.Forms.Button();
			this.MusicLogBox = new System.Windows.Forms.RichTextBox();
			...
			// tvMusicBrowser
			// 
			this.tvMusicBrowser.CheckBoxes = true;
			...
			// tvSoundBrowser
			// 
			this.tvSoundBrowser.CheckBoxes = true;
			...
			// DecodeAllMusic
			// 
			resources.ApplyResources(this.DecodeAllMusic, "DecodeAllMusic");
			this.DecodeAllMusic.Name = "DecodeAllMusic";
			this.DecodeAllMusic.Click += new System.EventHandler(this.DecodeAllMusic_Click);
			// 
			// MusicLogBox
			// 
			resources.ApplyResources(this.MusicLogBox, "MusicLogBox");
			this.MusicLogBox.Name = "MusicLogBox";
			// 
			// button1
			// 
			...
			this.Controls.Add(this.MusicLogBox);
			this.Controls.Add(this.DecodeAllMusic);
    ...
    private System.Windows.Forms.ToolTip ttInfo;
		private System.Windows.Forms.Button DecodeAllMusic;
		private System.Windows.Forms.RichTextBox MusicLogBox;
